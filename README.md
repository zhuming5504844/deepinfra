...
本项目提供一个基于 PySide6 + qdarktheme（pip 包名为 pyqtdarktheme，兼容版本固定为 0.1.7） 的 Python GUI，用于调用 DeepInfra Whisper API 完成语音转录并生成字幕。

## 功能
- 支持拖放或选择音频文件（支持常见音频格式）
- 使用 PySide6 + qdarktheme（pip 包名为 pyqtdarktheme，兼容版本固定为 0.1.7） 深色主题界面
